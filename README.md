...
| 2 | [**Data and Preparation - Practical Foundations**](https://github.com/maciejkepa/ai-ml-in-practice/tree/master/2_data_preparations) | Learn data preparation techniques for ML models. | • What a data pipeline looks like in ML<br>• Data cleaning in Pandas / PySpark<br>• Data validation with Great Expectations<br>• **Demo:** preparing a dataset in PySpark |
